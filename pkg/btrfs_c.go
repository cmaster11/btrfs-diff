...
// Entries straight from linux kernel btrfs send.h
// https://github.com/torvalds/linux/blob/master/fs/btrfs/send.h

const BTRFS_SEND_STREAM_MAGIC = "btrfs-stream"
const BTRFS_SEND_STREAM_VERSION = 1
...
const BTRFS_SEND_C_MAX_PLUS_ONE = BTRFS_SEND_C_MAX + 1
...
const BTRFS_SEND_A_MAX_V1_PLUS_ONE = BTRFS_SEND_A_MAX_V1 + 1
const BTRFS_SEND_A_MAX_PLUS_ONE = __BTRFS_SEND_A_MAX + 1
